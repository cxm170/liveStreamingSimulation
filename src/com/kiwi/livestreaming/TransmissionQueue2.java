...
public class TransmissionQueue2 {
	...
	public TransmissionQueue2(int maxNumberOfVideos, double unitVideoDuration, double bandwidthTimeslotWidth, double initDelay, double averageDelay, double unitVideoDelay, int slideWindow){
...
//	}
	...
	public double predictedBandwidth(double currentTime){
		...
		for(int i=0;i<number;i++){
			historicalBandwidths[i] = Statistics.inputBandwidths.get(currentTimeslot-i);
			sum += historicalBandwidths[i];
		}
